...
export const getIsoDate = (date) => {
  return moment(date, "MM/DD/YYYY").format("YYYY-MM-DDTHH:mm:ss.SSSZ");
};
  ...
  switch (type) {
    ...
    case "array":
      return {
        ...
        "array.min":
          "The array length must be greater than or equal to " + min + ".",
        "array.max":
          "The array length must be less than or equal to " + max + ".",
      };
    default:
      break;
  }
